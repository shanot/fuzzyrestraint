...
class Tests(IMP.test.TestCase):
    ...
    def test_cpp(self):
        ...
        for i in range(6):
            ...
            hs.append(h)
            IMP.atom.Mass.setup_particle(p,1.0)
        r1a=IMP.fuzzyrestraint.FuzzySigmoidRestraint(m, ps[0], ps[1])
        r1b=IMP.fuzzyrestraint.FuzzySigmoidRestraint(m, ps[0], ps[2])
        r1or = r1a|r1b
        r2a=IMP.fuzzyrestraint.FuzzySigmoidRestraint(m, ps[3], ps[4])
        r2b=IMP.fuzzyrestraint.FuzzySigmoidRestraint(m, ps[3], ps[5])
        r2or = r2a|r2b
        print(r1or.unprotected_evaluate(None))
        print(r2or.unprotected_evaluate(None))
        rand = r1or & r2or
